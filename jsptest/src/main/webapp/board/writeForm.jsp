...
<body bgcolor="${bodyback_c}">
	<br></br>
		...
		<form method="post" name="writeform" action="/jsptest/board/writePro.do"
			onsubmit="return writeSave()">
			<input type="hidden" name="num" value="${num}"> <input
				type="hidden" name="ref" value="${ref}"> <input
				type="hidden" name="step" value="${step}"> <input
				type="hidden" name="depth" value="${depth}">
			<table class="co" width="400" border="1" cellspacing="0" cellpadding="0"align="center">
				<tr>
					<td align="right" colspan="2" bgcolor="${value_c}"><a
						href="/jsptest/board/list.do"> 글목록</a></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="330"><c:if test="${num == 0}">
							<input type="text" size="37" maxlength="50" name="subject">
				...
				<tr>
					...
					<td width="330"><input type="text" size="37" maxlength="30"
						name="email"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input type="button" value="목록보기"OnClick="window.location='/jsptest/board/list.do'"></td>
				</tr>
			</table>
		</form>
</body>
